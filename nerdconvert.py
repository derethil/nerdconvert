...
def create_raw_data(resources, force_download=False, svgdir="svg"):
    ...
    print(
        "Generated svgicons from fontfile:",
...
def main():
    ...
    resources = {
        "fontfile": {
            "url": f"{base_url}/patched-fonts/NerdFontsSymbolsOnly/SymbolsNerdFontMono-Regular.ttf",
            "filepath": os.path.join(
                args.download, "Symbols-2048-em_Nerd_Font_Complete.ttf"
            ),
        },
        "cssfile": {
    ...
    for output in args.output:
        ...
        if exporter:
            ...
            exporter(output[0], data, record_formatter)
        else:
